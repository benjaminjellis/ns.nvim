...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    Derive = syntax_entry(palette.light_green, palette.none),
    Constant = syntax_entry(palette.yellow, palette.none),
    ...
    TSAttribute = { link = "Type" },
    TSBoolean = { link = "Type" },
    TSCharacter = { link = "Type" },
    ...
    ["@keyword.conditional.python"] = { link = "TSKeyword" },
    ...
    NavicIconsConstant = syntax_entry(palette.yellow, palette.none),
    ...
    NoiceCompletionItemKindConstant = syntax_entry(palette.yellow, palette.none),
