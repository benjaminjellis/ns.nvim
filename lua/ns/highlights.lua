...
local ColourUtility = require("ns.colour_utility")
...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    White = syntax_entry(palette.white, palette.none),
    ...
    -- Semantic Highlights
    Function = syntax_entry(palette.orange, palette.none),
    ...
    Decorator = syntax_entry(palette.purple, palette.none, { styles.italic }),
    Derive = syntax_entry(palette.purple, palette.none),
    Constant = syntax_entry(palette.constant, palette.none),
    String = syntax_entry(palette.string, palette.none, { styles.bold }),
    ...
    LineNr = syntax_entry(palette.orange, palette.none),
    ...
    Number = syntax_entry(palette.number, palette.none),
    ...
    Operator = syntax_entry(palette.white, palette.none),
    Special = { link = "Orange" },
    ...
    CurrentWord = syntax_entry(palette.none, palette.bg_visual),
    ...
    ["@lsp.typemod.generic.attribute"] = { link = "Fg" },
    ...
    ["@lsp.typemod.type.defaultLibrary.go"] = { link = "Green" },
    ...
    NavicIconsFunction = syntax_entry(palette.orange, palette.none),
    ...
    goBuiltins = { link = "Green" },
    goVarArgs = { link = "Grey" },

    -- Rust
    rustStructure = { link = "Type" },
    rustIdentifier = { link = "I" },
  ...
  if options.transparent_background_level == 0 then
    ...
    syntax["NvimTreeCursorLine"] = syntax_entry(palette.none, palette.bg1)
